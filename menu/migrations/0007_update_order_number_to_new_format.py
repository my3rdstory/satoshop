# Generated by Django migration for menu order number format update

from django.db import migrations
import uuid


def update_menu_order_number_format(apps, schema_editor):
    """기존 메뉴 주문번호를 새로운 형식으로 업데이트: store_id-menu-YYMM-해시값"""
    ...
    for order in menu_orders:
        try:
            ...
            new_order_number = f"{store_id}-menu-{year_month}-{hash_value}"
...
def reverse_menu_order_number_format(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            update_menu_order_number_format,
            reverse_menu_order_number_format,
        ),
    ] 