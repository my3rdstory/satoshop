...
class HeroCarouselSlide(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["is_active", "order"], name="hero_slide_active_order"),
        ]
    ...
    def overlay_style(self) -> str:
        return self.overlay_color or "rgba(2, 6, 23, 0.55)"
    ...
    def background_style(self) -> str:
        ...
        if self.background_image:
            declarations.append(
                f"background-image: url('{self.background_image.url}'); background-size: cover; "
