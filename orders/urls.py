...
urlpatterns = [
    ...
    path('<str:store_id>/payment-transactions/', views.payment_transactions, name='payment_transactions'),
    path('<str:store_id>/payment-transactions/<uuid:transaction_id>/', views.payment_transaction_detail, name='payment_transaction_detail'),
