...
- [x] 스토어 메인 노출 상품·밋업·강의·파일 순서 지정 화면 추가
- [x] 대문 노출 우선순위 저장/적용 로직 구현
- [x] README 및 변경 이력 업데이트
- [x] 스토어 상품 주문 목록 이메일 발송 요구사항 분석
- [x] 주문자 이메일 발송 API/서비스 구현
- [x] 주문 내역 UI/JS 이메일 발송 버튼 추가
- [x] 관련 문서 및 변경 이력 업데이트
