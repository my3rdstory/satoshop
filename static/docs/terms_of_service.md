...
본 약관은 "BTCMap"(이하 "본 플랫폼")에서 제공하는 비트코인 라이트닝 네트워크 기반 전자상거래 서비스(이하 "서비스")를 이용함에 있어 본 플랫폼과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.

## 제2조 (정의)

1. **"플랫폼"**이란 BTCMap이 운영하는 비트코인 라이트닝 네트워크 기반 전자상거래 웹사이트를 말합니다.
