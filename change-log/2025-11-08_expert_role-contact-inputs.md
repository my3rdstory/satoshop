...
- 최종 계약 PDF 저장 시 기본 스토리지 대신 S3Storage를 직접 사용해 서명 이미지와 동일하게 오브젝트 스토리지에 업로드되도록 했습니다.
- DirectContractDocument의 서명 이미지 및 최종 PDF 필드가 S3 스토리지를 사용하도록 강제해, 저장/조회 모두 물리적인 오브젝트 스토리지를 바라보도록 일원화했습니다.
