...
2. `expert/templates/expert/direct_contract_start.html` 4번째 카드가 Expert 기준 누적/최근 활동 값을 표시하도록 수정
3. `expert/templates/admin/expert/usage_stats.html`에서도 동일 지표를 사용하고, 전체 라이트닝 프로필 수는 보조 문구로 안내
